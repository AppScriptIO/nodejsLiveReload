...
exports.runWebappServer = runWebappServer;
...
function runWebappServer({
  ...
  fileBasePath = 'path' || _configuration.default.directory.serverSidePath,
  // /project/application/distribution/serverSide/
  ...
  browserSync.init({
    ...
    port: targetAppPort,
    proxy: {
      target: targetAppHost // ws: true // when localhost webapp uses websocket also.
